<?php
/**
 * Lavadora — role-aware navigation definitions + inline SVG icons.
 ...
 * page_key is used by the owner's page-access matrix.
 */
function role_nav(string $role): array
{
    ...
    if ($acc !== null && in_array($role, ['owner', 'staff'], true)) {
