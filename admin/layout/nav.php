...
function ia_icon(string $name, int $size = 18): string
{
    $map = [
        ...
        'scan-eye' => 'fa-solid fa-vr-cardboard',
...
{
    $systemHelp = in_array($role, ['owner', 'system_admin'], true)
        ? [['Help Center', '/admin/help', 'info']]
        : [];
        ...
        'admin' => [
            ...
            [
                ...
                'items' => [
                    ...
                    ['360 Capture Tool', '/admin/institution/ai', 'sparkles', 'admin.ai'],
                ]
            ],
            [
                'title' => 'Files',
