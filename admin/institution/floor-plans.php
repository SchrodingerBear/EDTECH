...
$search = $_GET['search'] ?? '';
$buildingId = $_GET['building_id'] ?? $_GET['building'] ?? '';
            ...
            <div class="ia-card h-100 d-flex flex-column">
                ...
                <div class="card-body d-flex flex-column flex-grow-1">
                    ...
                    <div class="mt-auto d-flex gap-2">
                        <a href="floor-plan/studio-view.php?id=<?= $fp['id'] ?>" class="btn btn-outline-ia flex-grow-1">Open Studio</a>
                        <a href="locations.php?fp=<?= $fp['id'] ?>" class="btn btn-outline-info">Locations</a>
        ...
        <div class="modal-content">
            <form id="addFloorPlanForm">
                ...
                <div class="modal-body">
                    ...
                    <?php
                        $pickerName = 'fp_image';
                        $pickerLabel = 'Floor Plan Image *';
                        $pickerValue = '';
                        $pickerSizeGuide = '16:9 landscape recommended — min 1920×1080px';
                        $pickerHelp = '';
        ...
        <div class="modal-content">
            <form id="editFloorPlanForm">
                ...
                <div class="modal-body">
                    ...
                    <?php
                        $pickerName = 'fp_image_edit';
                        $pickerLabel = 'Replace Image (Optional)';
                        $pickerValue = '';
                        $pickerHelp = 'Leave empty to keep the current image. Note: changing aspect ratio may offset existing markers!';
                        $pickerSizeGuide = '16:9 landscape recommended — min 1920×1080px';
                        require __DIR__ . '/../layout/media-picker-sweetalert.php';
                    ?>
                </div>
...
function editFloorPlan(id) {
    fetch('floor-plan/actions.php?action=get_floor_plan&floor_plan_id=' + id)
    .then(res => res.json())
    .then(data => {
        if (data.success) {
