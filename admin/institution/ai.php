 ...
 */
$pageTitle = '360 Capture Tool';
$pageSub = 'Stitch a 360 panorama from six cube faces';
$active = '360 Capture Tool';
$bodyClass = 'page-ai';
...
<!-- selfie stick suggestion modal -->
<div class="modal fade" id="selfie-stick-modal" tabindex="-1" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-lightbulb text-warning me-2"></i>Capture Tip</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <div class="text-center mb-3">
          <i class="fas fa-camera fa-3x text-primary mb-3"></i>
          <h6>Use a Selfie Stick for Better Results</h6>
        </div>
        <p class="text-muted mb-3">For more accurate 360° captures, we recommend using a selfie stick or tripod. This helps:</p>
        <ul class="text-muted mb-3">
          <li>Keep the camera at consistent height</li>
          <li>Reduce camera shake and blur</li>
          <li>Improve alignment between cube faces</li>
          <li>Minimize parallax errors</li>
        </ul>
        <div class="alert alert-info">
          <small><i class="fas fa-info-circle me-1"></i> A selfie stick extension arm (30-50cm) works best for indoor captures.</small>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-grad px-4" data-bs-dismiss="modal">Got it!</button>
      </div>
    </div>
  </div>
</div>
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    // Show selfie stick suggestion modal on first load
    if (!sessionStorage.getItem('selfieStickTipShown')) {
      const modal = new bootstrap.Modal(document.getElementById('selfie-stick-modal'));
      modal.show();
      sessionStorage.setItem('selfieStickTipShown', 'true');
    }
