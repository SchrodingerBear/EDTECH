...
$active = 'Floor Plans';
$bodyClass = 'page-floor-plans page-staff-floorplans-studio';

// Enqueue styles for studio
$extraHead = '<link rel="stylesheet" href="studio.css?v=3">';
...
<div class="row g-3" style="min-height: calc(100vh - 200px);">
    ...
    <div class="col-lg-3 col-xl-2">
        <div class="ia-card h-100 p-3">
            ...
            <div class="marker-tools-grid mb-3" id="marker-tools-list">
                ...
                <button type="button" class="marker-tool draggable" draggable="true" data-type="room" title="Bind this spot to a room">
                    <span class="tool-icon tool-icon-room">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 3h9a2 2 0 0 1 2 2v16l-4-2H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2Z"/><path d="M10 8h6"/><path d="M10 12h6"/><path d="M10 3v18"/></svg>
                    </span>
                    <span class="tool-label">Room</span>
                </button>

                <button type="button" class="marker-tool draggable" draggable="true" data-type="area" title="Bind this spot to a campus area">
                    <span class="tool-icon tool-icon-area">
    ...
    <div class="col-lg-6 col-xl-7">
        <div class="ia-card h-100 p-0 overflow-hidden d-flex flex-column" id="studio-canvas-container" style="background: #0f172a;">
            <div class="px-3 py-2 border-bottom d-flex align-items-center justify-content-between text-light" style="background: rgba(0,0,0,0.25); min-height: 42px;">
