...
<body>
    ...
    <div aria-hidden="true" aria-labelledby="stitch-title" aria-modal="true" class="ui-card" id="stitching-overlay" role="dialog">
        ...
        <div class="card-content">
            ...
            <canvas data-thumbnail="<?php echo $basePath; ?>img/360_blank_thumbnail.jpg" height="300" id="preview-canvas" width="600"></canvas>
            <div class="action-stack">
                ...
                <button aria-label="Start new capture" class="start-btn-styled" id="start-new-capture-btn" onclick="window.sphereCapture && window.sphereCapture.resetAndStartNewCapture()">
                    <img alt="Camera icon" class="camera-ico" src="<?php echo $basePath; ?>img/camera.svg"/> Start New Capture
                </button>
            </div>
        </div>
    </div>
    ...
    <div aria-labelledby="home-title" class="ui-card home-card visible" id="start-screen" role="main">
        <div class="card-header">
            <img alt="Photosphere Camera Logo" class="logo logo-glow" src="<?php echo $basePath; ?>img/logo_150x150.png" width="60"/>
        ...
        <div class="card-content">
            <div class="home-instructions">
                <div class="step-row">
                    ...
                    <span>Hold your device close to your face, and rotate your body to find the <span class="hl-orange">orange</span> hotspots</span>
                </div>
                <div class="step-row">
        ...
        <div class="card-content">
            <div class="settings-menu-list">
                <button aria-label="About VFTCam" class="settings-menu-item" onclick="window.sphereCapture && window.sphereCapture.cardUI && window.sphereCapture.cardUI.openInfoCard('about')">
                    <div class="menu-row">
                        <img alt="" src="<?php echo $basePath; ?>img/about.svg"/> <span>About This App</span>
                    </div>
                    <span>›</span>
                </button>
                <button aria-label="Privacy policy" class="settings-menu-item" onclick="window.sphereCapture && window.sphereCapture.cardUI && window.sphereCapture.cardUI.openInfoCard('privacy')">
                    <div class="menu-row">
                        <img alt="" src="<?php echo $basePath; ?>img/privacy.svg"/> <span>Privacy</span>
                    </div>
                    <span>›</span>
                </button>
                <button aria-label="Field of view fine-tuning" class="settings-menu-item" onclick="window.sphereCapture && window.sphereCapture.cardUI && window.sphereCapture.cardUI.openInfoCard('fov')">
                    <div class="menu-row">
                        <img alt="" src="<?php echo $basePath; ?>img/fov-calibration.svg"/> <span>FOV Fine-Tuning</span>
                    </div>
                    <span>›</span>
                </button>
                <button aria-label="Clear camera roll" class="settings-menu-item" onclick="window.sphereCapture && window.sphereCapture.cardUI && window.sphereCapture.cardUI.openInfoCard('clear')">
                    <div class="menu-row">
                        <img alt="" class="danger-icon" src="<?php echo $basePath; ?>img/clear-camera-roll.svg"/> <span class="danger-text">Clear Camera Roll</span>
                    </div>
                    <span>›</span>
                </button>
            </div>
    ...
    <script src="<?php echo $basePath; ?>js/capture.js" type="module"></script>
</body>
</html>