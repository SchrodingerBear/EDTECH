  ...
  function Ba (P) {
    ...
    function Y (a, e, f, m, p) {
      ...
      if (c) {
        ...
        t = Math.abs(t)
        e.diff = Math.acos(
          Math.sin(f) * Math.sin(g) + Math.cos(f) * Math.cos(g) * Math.cos(t)
        )
        t = !1
        ...
        if (e.level < d.level) {
          ...
          if (E < s.tileResolution)
            if (e.x == t && e.y != t) {
              ...
              e.x != t &&
                e.y == t &&
                ((l = v = 0.5), 'l' == e.side || 'r' == e.side) &&
                (D = I = 0.5)
          z <= s.tileResolution &&
            (e.x == t &&
              ((v = 0), (l = 1), 'l' == e.side || 'r' == e.side) &&
              ((I = 0), (D = 1)),
            e.y == t &&
              ((Q = 0), (A = 1), 'd' == e.side || 'u' == e.side) &&
              ((I = 0), (D = 1)))
          E = [
            c[0],
            c[1],
    ...
    this.init = function (h, e, Ia, ja, p, c, g, t) {
      ...
      if (
        !a &&
        (('multires' == G && s.hasOwnProperty('fallbackPath')) ||
          'cubemap' == G) &&
        ...
        p = function () {
          ...
          for (h = 2; h < a.width - 2; h++)
            for (l = 0; 4 > l; l++)
              (d[4 * (h + a.width) + l] = d[4 * (h + 2 * a.width) + l]),
                (d[4 * (h + a.width * (a.height - 2)) + l] =
                  d[4 * (h + a.width * (a.height - 3)) + l])
          ...
          for (l = 0; 4 > l; l++)
            (d[4 * (a.width + 1) + l] = d[4 * (2 * a.width + 2) + l]),
              ...
              (d[4 * (a.width * (a.height - 2) + 1) + l] =
                d[4 * (a.width * (a.height - 3) + 2) + l]),
              (d[4 * (a.width * (a.height - 1) - 2) + l] =
                d[4 * (a.width * (a.height - 2) - 3) + l])
          for (h = 1; h < a.width - 1; h++)
            for (l = 0; 4 > l; l++)
              (d[4 * h + l] = d[4 * (h + a.width) + l]),
                (d[4 * (h + a.width * (a.height - 1)) + l] =
                  d[4 * (h + a.width * (a.height - 2)) + l])
          ...
          for (l = 0; 4 > l; l++)
            (d[l] = d[4 * (a.width + 1) + l]),
              (d[4 * (a.width - 1) + l] = d[4 * (2 * a.width - 2) + l]),
              (d[a.width * (a.height - 1) * 4 + l] =
                d[4 * (a.width * (a.height - 2) + 1) + l]),
              (d[4 * (a.width * a.height - 1) + l] =
                d[4 * (a.width * (a.height - 1) - 2) + l])
        ...
        for (h = 0; 6 > h; h++)
          (c = new Image()),
            ...
            (c.src =
              'multires' == G
                ? encodeURI(ja.replace('%s', z[h]) + '.' + s.extension)
                : encodeURI(s[h].src))
      } else {
        if (!a)
          throw (
        ...
        if ('equirectangular' == G) {
          if (
            ...
            throw (
              ...
              { type: 'webgl size error', width: h, maxWidth: e })
            )
        } else if (
          'cubemap' == G &&
          ((h = s[0].width),
        ...
        t === m ||
          (t.horizonPitch === m && t.horizonRoll === m) ||
          (fa = [
            t.horizonPitch == m ? 0 : t.horizonPitch,
            t.horizonRoll == m ? 0 : t.horizonRoll
          ])
        h = a.TEXTURE_2D
        ...
        a.getShaderParameter(N, a.COMPILE_STATUS) ||
          console.log(a.getShaderInfoLog(N))
        ...
        'multires' != G
          ? (ka || (ka = a.createBuffer()),
            ...
            'equirectangular' == G &&
              ...
              a.uniform4fv(
                d.backgroundColor,
                (t.backgroundColor ? t.backgroundColor : [0, 0, 0]).concat([1])
              )),
            ...
            'cubemap' == G
              ...
              : a.texImage2D(h, 0, a.RGB, a.RGB, a.UNSIGNED_BYTE, s),
        ...
        if (0 !== ja)
          throw (
            (console.log('Error: Something went wrong with WebGL!', ja),
            { type: 'webgl error' })
          )
        g()
      }
    ...
    this.destroy = function () {
      P !== m &&
        (A !== m && P.contains(A) && P.removeChild(A),
    ...
    this.resize = function () {
      ...
      a &&
        ...
        a.viewport(0, 0, a.drawingBufferWidth, a.drawingBufferHeight),
        'multires' != G &&
          a.uniform1f(d.aspectRatio, A.clientWidth / A.clientHeight))
    }
    this.resize()
    ...
    this.render = function (h, e, f, r) {
      ...
      if (fa !== m) {
        var c = fa[0],
          ...
          z = e,
          y =
            Math.cos(g) * Math.sin(h) * Math.sin(c) +
            Math.cos(h) *
              (Math.cos(c) * Math.cos(e) +
                Math.sin(g) * Math.sin(c) * Math.sin(e)),
          v =
            -Math.sin(h) * Math.sin(g) + Math.cos(h) * Math.cos(g) * Math.sin(e)
        h =
          Math.cos(g) * Math.cos(c) * Math.sin(h) +
          Math.cos(h) *
            (-Math.cos(e) * Math.sin(c) +
              Math.cos(c) * Math.sin(g) * Math.sin(e))
        h = Math.asin(Math.max(Math.min(h, 1), -1))
        e = Math.atan2(v, y)
        c = [
          Math.cos(t) *
            (Math.sin(g) * Math.sin(c) * Math.cos(z) -
              Math.cos(c) * Math.sin(z)),
          Math.cos(t) * Math.cos(g) * Math.cos(z),
          Math.cos(t) *
            (Math.cos(c) * Math.sin(g) * Math.cos(z) +
              Math.sin(z) * Math.sin(c))
        ]
      ...
      if (a || ('multires' != G && 'cubemap' != G)) {
        if ('multires' != G)
          (f =
            2 *
            Math.atan(
              Math.tan(0.5 * f) / (a.drawingBufferWidth / a.drawingBufferHeight)
            )),
            (f = 1 / Math.tan(0.5 * f)),
            a.uniform1f(d.psi, e),
          ...
          g =
            2 *
            Math.atan(
              (Math.tan(f / 2) * a.drawingBufferHeight) / a.drawingBufferWidth
            )
          g = 1 / Math.tan(g / 2)
          c = [
            g / c,
          ...
          for (
            ...
            a.drawingBufferWidth >
              s.tileResolution * Math.pow(2, g - 1) * Math.tan(f / 2) * 0.707;
          ...
          if (
            ...
            for (
              g = d.nodeCache.splice(200, d.nodeCache.length - 200), p = 0;
              p < g.length;
              p++
            )
          ...
          if (!d.drawInProgress) {
            ...
            for (h = 0; h < d.currentNodes.length; h++)
              d.currentNodes[h].textureLoaded &&
                (a.bindBuffer(a.ARRAY_BUFFER, F),
                a.bufferData(
                  a.ARRAY_BUFFER,
                  new Float32Array(d.currentNodes[h].vertices),
                  a.STATIC_DRAW
                ),
    ...
    var Ma = (function () {
      function d () {
        ...
        this.image.addEventListener('load', function () {
          ...
          p.length
            ? ((c = p.shift()), e.loadTexture(c.src, c.texture, c.callback))
            : (m[f++] = e)
        })
      }
      function e (a, c, d) {
...
window.pannellum = (function (J, f, m) {
  function Ba (r, v) {
    function Oa (u) {
      ...
      u && null !== u.alpha && null !== u.beta && null !== u.gamma
        ? (w.container.appendChild(w.orientation), (pa = !0), Ya && Ka())
        : (pa = !1)
    }
    function Na () {
        ...
        if ('cubemap' == b.type) {
          ...
          (u = JSON.parse(JSON.stringify(b.multiRes))),
            ...
            !/^(?:[a-z]+:)?\/\//i.test(b.multiRes.basePath)
              ? (u.basePath = b.basePath + b.multiRes.basePath)
              : b.multiRes.basePath
              ? (u.basePath = b.multiRes.basePath)
              : b.basePath && (u.basePath = b.basePath),
            (O = u)
    ...
    function P () {
      ...
      Sa ||
        ...
        b.mouseZoom &&
          (C.addEventListener('mousewheel', na, !1),
        ...
        if (-1 < c && !0 !== b.ignoreGPanoXMP) {
          var d = ca.substring(c, ca.indexOf('</x:xmpmeta>') + 12),
            e = function (a) {
              var u
              0 <= d.indexOf(a + '="')
                ? ((u = d.substring(d.indexOf(a + '="') + a.length + 2)),
                  (u = u.substring(0, u.indexOf('"'))))
                : 0 <= d.indexOf(a + '>') &&
                  ((u = d.substring(d.indexOf(a + '>') + a.length + 1)),
                  (u = u.substring(0, u.indexOf('<'))))
          ...
          null !== ca &&
            ...
            null !== g &&
            null !== h &&
            (0 > da.indexOf('haov') && (b.haov = (c / ca) * 360),
            0 > da.indexOf('vaov') && (b.vaov = (g / f) * 180),
            0 > da.indexOf('vOffset') &&
              (b.vOffset = -180 * ((h + g / 2) / f - 0.5)),
            null !== l &&
              0 > da.indexOf('northOffset') &&
              ((b.northOffset = l), !1 !== b.compass && (b.compass = !0)),
            null !== p &&
              null !== e &&
              (0 > da.indexOf('horizonPitch') && (b.horizonPitch = p),
    ...
    function ra (a) {
      b.minHfov === b.hfov
        ? za.setHfov(wa, 1e3)
        : ((a = sa(a)), za.lookAt(a[0], a[1], b.minHfov, 1e3))
    }
    function sa (a) {
      var k = Y(a)
      a = B.getCanvas()
    ...
    function La (a) {
      if (la && L) {
        ...
        var d =
          (((180 *
            (Math.atan((xa / c) * 2 - 1) - Math.atan((a.x / c) * 2 - 1))) /
            Math.PI) *
            b.hfov) /
            90 +
          Qa
        ...
        b.yaw = d
        c =
          (360 * Math.atan((Math.tan((b.hfov / 360) * Math.PI) * k) / c)) /
          Math.PI
        c =
          (((180 *
            (Math.atan((a.y / k) * 2 - 1) - Math.atan((ya / k) * 2 - 1))) /
            Math.PI) *
            c) /
            90 +
          Ra
    ...
    function A (a) {
      if (b.draggable && (a.preventDefault(), L && (S = Date.now()), la && L)) {
        ...
        2 == a.targetTouches.length &&
          -1 != Fa &&
          ((a = Y(a.targetTouches[1])),
          (c += 0.5 * (a.x - k.x)),
          (d += 0.5 * (a.y - k.y)),
          (k = Math.sqrt(
            (k.x - a.x) * (k.x - a.x) + (k.y - a.y) * (k.y - a.y)
          )),
          U(b.hfov + 0.1 * (Fa - k)),
          (Fa = k))
        k = b.hfov / 360
    ...
    function na (a) {
      L &&
        ('fullscreenonly' != b.mouseZoom || Ga) &&
        (a.preventDefault(),
        Ja(),
        (S = Date.now()),
        a.wheelDeltaY
          ? (U(b.hfov - 0.05 * a.wheelDeltaY),
            (x.hfov = 0 > a.wheelDelta ? 1 : -1))
          : a.wheelDelta
          ? (U(b.hfov - 0.05 * a.wheelDelta),
            (x.hfov = 0 > a.wheelDelta ? 1 : -1))
          : a.detail &&
            (U(b.hfov + 1.5 * a.detail), (x.hfov = 0 < a.detail ? 1 : -1)),
        F())
    }
    function R (a) {
      Ja()
    ...
    function G () {
      if (L) {
        ...
        q[0] &&
          !0 === b.keyboardZoom &&
          (U(b.hfov + (0.8 * x.hfov + 0.5) * f), (a = !0))
        q[1] &&
          !0 === b.keyboardZoom &&
          (U(b.hfov + (0.8 * x.hfov - 0.2) * f), (a = !0))
        ...
        0 < f &&
          !b.autoRotate &&
          (q[4] || q[5] || q[8] || q[9] || K.yaw || (b.yaw += x.yaw * f * 0.85),
          q[2] ||
            q[3] ||
            q[6] ||
            q[7] ||
            K.pitch ||
            (b.pitch += x.pitch * f * 0.85),
          q[0] || q[1] || K.hfov || U(b.hfov + x.hfov * f * 0.85))
        ia = e
        0 < f &&
          ((x.yaw = 0.8 * x.yaw + ((b.yaw - c) / f) * 0.2),
    ...
    function va (a) {
      var k = K[a],
        c = Math.min(
          1,
          Math.max((Date.now() - k.startTime) / 1e3 / (k.duration / 1e3), 0)
        ),
        c =
          k.startPosition +
          b.animationTimingFunction(c) * (k.endPosition - k.startPosition)
      if (
        (k.endPosition > k.startPosition && c >= k.endPosition) ||
        (k.endPosition < k.startPosition && c <= k.endPosition) ||
        k.endPosition === k.startPosition
      ) {
        c = k.endPosition
        x[a] = 0
        var k = K[a].callback,
    ...
    function ba () {
      ...
      if (la || !0 === aa) requestAnimationFrame(ba)
        ...
        K.hfov ||
        0.01 < Math.abs(x.yaw) ||
        0.01 < Math.abs(x.pitch) ||
        0.01 < Math.abs(x.hfov)
      )
        G(),
          0 <= b.autoRotateInactivityDelay &&
            ...
            !b.autoRotate &&
            ((b.autoRotate = $), za.lookAt(Ea, m, wa, 3e3)),
        ...
        0 < a
          ...
          : 0 <= b.autoRotateInactivityDelay &&
            $ &&
            ((b.autoRotate = $), za.lookAt(Ea, m, wa, 3e3), F())
      }
    }
    function Da () {
      var a
      if (L) {
        ...
        a =
          ((2 *
            Math.atan(
              Math.tan((b.hfov / 180) * Math.PI * 0.5) / (a.width / a.height)
            )) /
            Math.PI) *
          180
        k = b.minPitch + a / 2
        ...
        b.compass &&
          ((Ha.style.transform = 'rotate(' + (-b.yaw - b.northOffset) + 'deg)'),
          (Ha.style.webkitTransform =
    ...
    function Ma (a) {
      ...
      c = new Z(
        ...
        d[0] * c[1] * c[2] - c[0] * d[1] * d[2],
        c[0] * d[1] * c[2] + d[0] * c[1] * d[2],
        c[0] * c[1] * d[2] + d[0] * d[1] * c[2]
      )
      ...
      'number' == typeof aa && 10 > aa
        ? (aa += 1)
        : 10 === aa
        ? ((ab = (c[2] / Math.PI) * 180 + b.yaw),
          (aa = !0),
          requestAnimationFrame(ba))
        : ((b.pitch = (c[0] / Math.PI) * 180),
    ...
    function Ia (a) {
      ...
      c.className = a.cssClass
        ? c.className + (' ' + a.cssClass)
        : c.className + (' pnlm-hotspot pnlm-sprite pnlm-' + D(a.type))
    ...
    function p () {
      ...
      if (a)
        for (var c = 0; c < a.length; c++) {
          for (var d = a[c].div; d.parentNode != M; ) d = d.parentNode
          M.removeChild(d)
          delete a[c].div
        }
    }
        ...
        if (v.default.hasOwnProperty(c))
          if ('strings' == c)
            for (d in v.default.strings)
              v.default.strings.hasOwnProperty(d) &&
                (b.strings[d] = D(v.default.strings[d]))
          ...
          switch (e) {
            ...
            case 'fallback':
              n.errorMsg.innerHTML =
                '<p>Your browser does not support WebGL.<br><a href="' +
                encodeURI(b[e]) +
            ...
            case 'showControls':
              b[e] ||
                ((w.orientation.style.display = 'none'),
    ...
    function E (a) {
      ...
      'multires' == b.type &&
        ...
        (c = Math.min(
          c,
          B.getCanvas().width / ((b.multiRes.cubeResolution / 90) * 0.9)
        ))
      return c > b.maxHfov
    ...
    function I (a, c, d, e, f) {
      ...
      h =
        'same' === d
          ? b.yaw
          : 'sameAzimuth' === d
          ? b.yaw + (b.northOffset || 0) - (v.scenes[a].northOffset || 0)
          : d
      l = 'same' === e ? b.hfov : e
      p()
      g(a)
    ...
    ;(f.fullscreenEnabled ||
      ...
      w.container.appendChild(w.fullscreen)
    ...
    v.firstScene
      ? g(v.firstScene)
      : v.default && v.default.firstScene
      ? g(v.default.firstScene)
      : g(null)
    t(!0)
    var ma = [],
      Aa = []
    ...
    this.addHotSpot = function (a, d) {
      if (d === m && b.scene === m) b.hotSpots.push(a)
        ...
        if (v.scenes.hasOwnProperty(e))
          v.scenes[e].hasOwnProperty('hotSpots') ||
            ((v.scenes[e].hotSpots = []),
    ...
    this.destroy = function () {
      B && B.destroy()
      Sa &&
        (H.removeEventListener('mousedown', Ca, !1),
